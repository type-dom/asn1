 ...
 * ------------------------------------------------------------------
 *
 * OFD（Open Financial Document）文档格式中，数字签名所使用的 OID（Object Identifier）是可自定义的，因此具体的 OID 值可能因应用而异。不过根据国家标准的相关规定，一些常见的 OID 值如下：
 * sha1WithRSAEncryption：1.2.840.113549.1.1.5
 * sha256WithRSAEncryption：1.2.840.113549.1.1.11
 * sm2signwithsm3：1.2.156.10197.1.501 （中国国家密码管理局推荐的 SM2 算法签名 OID）
 */
interface IOIds {
  [propName: string]: {
    d: string,
